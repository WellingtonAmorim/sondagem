...
driver.get("https://enquetes.sphinxnaweb.com/cnipesquisa/SI_jul_2021/relat%C3%B3rio.htm")
...
df.to_excel('Selenium_codes_SI.xlsx')

driver.close()

df1 = pd.read_excel('SI.xlsx')
df2 = pd.read_excel('Selenium_codes_SI.xlsx')
